...
// {
//     public void Add<T>(string key, ExecutionResult<T> result) where T : class, IExecutionPlanResultContract;
//     public ImmutableList<ExecutionResult<IExecutionPlanResultContract>> Results();
// }
//
// public interface IExecutionContextResultRepository
// {
//     public ExecutionResult<T>? Get<T>(string key) where T : class, IExecutionPlanResultContract;
//     public bool Any();
//     public int Count();
// }